...
def execute(filters=None):
    ...
    for row in data:
        chart_data["data"]["labels"].append(row["item"])
        chart_data["data"]["datasets"][0]["values"].append(row["amount"])
        chart_data["data"]["datasets"][1]["values"].append(row["prev_amount"])
        chart_data["data"]["datasets"][2]["values"].append(row["current_amount"])
